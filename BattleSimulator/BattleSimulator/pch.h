...
enum JobType { JOB_NONE, JOB_FIGHTER, JOB_SCOUT, JOB_ACOLYTE, JOB_MAGE, JOB_WARRIOR, JOB_KNIGHT, JOB_BARBARIAN, JOB_ROGUE };
...
enum AbilityType { ABILITY_NONE, ABILITY_ATTACK_MELEE, ABILITY_ATTACK_RANGE, ABILITY_ATTACK_MAGIC, ABILITY_SPECIAL };
...
enum EventType { EVENT_NONE, EVENT_ATTACK, EVENT_CAUSE_DAMAGE, EVENT_CAUSE_STATUS, EVENT_REMOVE_STATUS, EVENT_REPOSITION }; 
...
enum Skill { 
	...
	SLASH, PROVOKE, DEMORALIZING_SHOUT, CHARGE, RALLY, CHALLENGE, FLURRY, POWER_ATTACK,
	LASSO, NEEDLELIGHT, FEINT, VENOMOUS_STRIKE };
