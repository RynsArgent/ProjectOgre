...
enum DamageRating { DAMAGE_NONE, DAMAGE_MINOR, DAMAGE_LOW, DAMAGE_MEDIUM, DAMAGE_HIGH, DAMAGE_MASSIVE, DAMAGE_COLOSSAL };
...
enum TargetType { TARGET_CONFUSED, TARGET_CHARMED, TARGET_RANDOM, TARGET_WEAKEST, TARGET_STRONGEST, TARGET_MOST_BUFFS, TARGET_MOST_DEBUFFS };

enum Skill { NO_STANDARD_SKILL, HUNDRED_BLADES, BLOCK, STRIKE, TAUNT, BATTLE_SHOUT, SHOOT, FOREWARN, SCOPE, TANGLE_TRAP, HEAL, CLEANSE };
