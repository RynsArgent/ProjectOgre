...
enum JobType { JOB_NONE, JOB_FIGHTER, JOB_SCOUT, JOB_ACOLYTE, JOB_MAGE, JOB_WARRIOR, JOB_KNIGHT, JOB_BARBARIAN, JOB_ROGUE, JOB_HUNTER, JOB_ARCHER, JOB_BARD, JOB_PRIEST, JOB_PUGILIST, JOB_WIZARD, JOB_ENCHANTER, JOB_DRUID, JOB_TREE_OF_LIFE };
...
enum DamageType { DAMAGE_TYPELESS, DAMAGE_PHYSICAL, DAMAGE_ARCANE, DAMAGE_FIRE, DAMAGE_WATER, DAMAGE_EARTH, DAMAGE_ICE, DAMAGE_LIGHTNING, DAMAGE_HEALING, DAMAGE_HOLY, DAMAGE_SHADOW };
...
enum EventType { EVENT_NONE, EVENT_ATTACK, EVENT_CAUSE_DAMAGE, EVENT_CAUSE_STATUS, EVENT_REMOVE_STATUS, EVENT_REPOSITION, EVENT_RAISE }; 

enum Skill { 
	NO_STANDARD_SKILL, 
	HUNDRED_BLADES, BLOCK, STRIKE, TAUNT, BATTLE_SHOUT, 
	SHOOT, HASTE, SCOPE, TANGLE_TRAP, 
	MEND, HEAL, CLEANSE, DISPEL, REGENERATION, BLIND, FLASH,
	...
	LASSO, PIERCETHROUGH, FEINT, VENOMOUS_STRIKE, CRIPPLING_SHOT, CONFUSE_TRAP, HUNTERS_MARK, TRANQUILIZING_SHOT, CHARM_TRAP, QUICK_NOCK, RAPID_SHOT, VOLLEY, SNIPE,
	REFORMATION, LULLABY, BALLAD_OF_HEROES, REQUIEM_OF_WAR, BANISH, GREATER_HEAL, RAISE, LIGHTNING_KICKS, HURRICANE_KICK, ROUNDHOUSE, LEG_SWEEP,
	BLINK, ARCANE_MISSIL, WATERBLAST, FLAMESTRIKE, ICICLE, ELECTRIC_CURTAIN, ROCKSLIDE, FASCINATION, STUN_WAVE, NOXIOUS_SPORES, PARALYTIC_CLOUD, SLEEP_MIASMA, CHILLING_FOG, DISORIENTING_MIST, ENERVATE, NATURES_GRASP, NATURES_EMBRACE, MANA_TREE,
	TRANQUILITY
};
enum SkillSet { SPELL1, SPELL2, SPELL_DEBUFF1 };
