...
enum JobType { JOB_NONE, JOB_FIGHTER, JOB_SCOUT, JOB_ACOLYTE, JOB_MAGE, JOB_WARRIOR, JOB_KNIGHT, JOB_BARBARIAN, JOB_ROGUE, JOB_HUNTER, JOB_ARCHER, JOB_BARD, JOB_PRIEST, JOB_PUGILIST, JOB_WIZARD, JOB_ENCHANTER };
...
enum Skill { 
	...
	BLINK, ARCANE_MISSIL, WATERBLAST, FLAMESTRIKE, ICICLE, ELECTRIC_CURTAIN, ROCKSLIDE, FASCINATION, STUN_WAVE, NOXIOUS_SPORES, PARALYTIC_CLOUD, SLEEP_MIASMA, CHILLING_FOG, DISORIENTING_MIST, NATURES_GRASP, NATURES_EMBRACE
};
